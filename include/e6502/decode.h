...
namespace E6502
{
    ...
    enum InstructionsBitMasks
    {
        ...
        // Instructions with more than 1 addressing mode
        ...
        JMP_ZEROS_BITMASK = 0b10010011,
        JMP_ONES_BITMASK = 0b01001100,
        ...
        ROL_ONES_BITMASK = 0b00100010,
        ROR_ZEROS_BITMASK = 0b10000001,
        ROR_ONES_BITMASK = 0b01100010,
    ...
    static const std::vector<InstructionMask> instructionMasks = {
        ...
        {JMP_ZEROS_BITMASK, JMP_ONES_BITMASK, JMP},
